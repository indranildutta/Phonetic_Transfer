...
\begin{itemize}
	...
	\item \textbf{H2---Asymmetry}: Based on existing literature evidencing targeted and phonologically-constrained shifts, and comparisons with Bengali vowels from \cite{dutta2021}, we expect \nt{2} to be lowered and fronted in the mixed condition. \nt{\ae} is expected to be fronted. We expect the extent of shift in \nt{\ae} to be lesser than \nt{2}, as it is in a part of the IE vowel space that has greater vowel density.
