...
\begin{figure}[h] %\centering
	...
	\caption{Vowel quality in unilinual English (solid lines), mixed condition (dotted lines), and baseline Bengali (colored ellipses) productions}
	\label{vowels_e_b}
\end{figure}
