...
\begin{abstract}
This study investigates the phonetic outcome of mixed-language production in a group of highly proficient bilingual speakers of Bengali and English, to better understand the nature of cross-language phonetic interaction. Existing research has largely focused on a small set of phonologically related languages and used voice onset time (VOT) to measure phonetic transfer. Results indicate that such interaction is mediated by both language-specific features and linguistic experience, highlighting the need for diversification in the range of languages and populations studied. We compare productions from a yet-unstudied population in two conditions-- unilingual L2 (English) and mixed (Bengali and English). The spectral properties of two L2 vowel categories— \nt{\ae} (common to L1 and L2) and \nt{2} (absent in L1) are examined as sites for transfer. To understand how this unfolds dynamically, we measure F1 and F2 at five points over the course of articulating the vowel. We find dynamic and asymmetrical changes in both vowels during mixed production, with \nt{2} shifting towards a related L1 category \nt{a:}. We interpret this as a temporary increase in cross-language phonetic influence during mixed-language use, leading to a shift towards L1 norms. Mixed language is elicited in two switching paradigms: cued picture-naming and code-switching, to assess if differences between the paradigms independently influence the outcome of phonetic interaction. Results reveal no difference in transfer patterns across the two paradigms. We discuss these findings in light of recent proposals about asymmetries in short-term phonetic interaction and the postulated role of connected speech in introducing discursive factors to transfer studies. 
\end{abstract}

\begin{keywords}
 phonetic transfer; vowel quality; bilingual speech production; L1-L2 interaction; Indian English; Bengali 
\end{keywords}
...
The data files and analysis code are available at:  \url{https://osf.io/dsb2x/?view_only=5cb821070bc74a038a293239157c3b11}
